...
export function Calendar() {
    ...
    return (jsx(React.Fragment, null,
        jsx("h2", { style: { fontSize: "1.2rem", paddingLeft: "2rem" } },
            jsx("input", { value: year, min: 1900, max: 2100, type: "number", onChange: (e) => setYear(Number(e.target.value)) }),
            "/",
            jsx("input", { value: month, min: 1, max: 12, type: "number", onChange: (e) => {
                    const month = Number(e.target.value);
                    assertIsMonth(month);
                    setMonth(month);
                } })),
        jsx("div", { style: { display: "grid", gridTemplateColumns: "repeat(7,1fr)" } },
            new Array(pad).fill(0).map(() => (jsx("div", null))),
